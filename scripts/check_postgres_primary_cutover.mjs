...
const legacyRepositories = new Set([
  ...
  "modules/billing/billing-ledger.service.ts",
  "modules/billing/billing.service.ts",
  "modules/billing/domestic-payment-notifications.ts",
  "modules/billing/apple-server-notifications.ts",
  "modules/account/account.service.ts",
  "modules/account/account-consent.service.ts",
  "modules/diagnostics/app-errors.repository.ts",
  "modules/terms/terms.repository.ts",
  "modules/voice-identities/voice-identities.service.ts",
  "modules/voice-identities/voice-identity-deletion-recovery.ts",
  "modules/voice-profiles/voice-profiles.service.ts",
...
const legacyImportAllowlist = new Set([
  "infrastructure/storage/postgres-primary-import-records.ts",
  "modules/ingress/ingress-runtime.repository.ts",
  "modules/events/reliable-events-runtime.repository.ts",
  "modules/provider-operations/provider-operations-runtime.repository.ts",
  "modules/recordings/recording-artifacts-runtime.repository.ts",
  "modules/recordings/recordings-runtime.repository.ts",
  "modules/worker-dispatches/worker-dispatch-runtime.repository.ts",
  "modules/sessions/session-completion.ts",
  "modules/sessions/sessions-runtime.repository.ts",
  "modules/call-links/call-playbacks-runtime.repository.ts",
  ...
  "modules/agent-calls/agent-consult-runtime.repository.ts",
  "modules/plans/plans-runtime.service.ts",
  "modules/usage/usage-hold-runtime.service.ts",
  "modules/billing/billing-runtime.service.ts",
  "modules/billing/domestic-payment-notifications-runtime.ts",
  "modules/billing/apple-server-notifications-runtime.ts",
  "modules/sessions/session-usage-settlement.ts",
  "modules/account/account-runtime.service.ts",
  "modules/account/account-consent-runtime.service.ts",
  "modules/account/account-export-runtime.service.ts",
  "modules/diagnostics/app-errors-runtime.repository.ts",
  "modules/terms/terms-runtime.repository.ts",
