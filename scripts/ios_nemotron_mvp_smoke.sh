...
export DEVICE_ASR_VAD_PROVIDER DEVICE_ASR_VAD_THRESHOLD
export DEVICE_ASR_VAD_NEGATIVE_THRESHOLD DEVICE_ASR_VAD_PRE_ROLL_MS
export DEVICE_ASR_DIAGNOSTIC_CAPTURE
...
Environment:
  ...
  DEVICE_ASR_* endpoint/VAD tuning
                                  600ms min speech, FluidAudio Silero VAD,
                                  hysteresis and 800ms pre-roll by default.
