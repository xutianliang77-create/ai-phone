...
ASR_SERVICE_HOST="${ASR_SERVICE_HOST:-127.0.0.1}"
SPEAKER_SERVICE_HOST="${SPEAKER_SERVICE_HOST:-127.0.0.1}"
TRANSLATION_SERVICE_HOST="${TRANSLATION_SERVICE_HOST:-127.0.0.1}"
TTS_SERVICE_HOST="${TTS_SERVICE_HOST:-127.0.0.1}"
...
API_BASE_URL="${API_BASE_URL:-http://127.0.0.1:3110}"
REALTIME_WS_ENDPOINT="${REALTIME_WS_ENDPOINT:-ws://$PUBLIC_HOST:3111/realtime}"
PUBLIC_RATE_LIMIT_REDIS_URL="${PUBLIC_RATE_LIMIT_REDIS_URL:-redis://127.0.0.1:6379/1}"
SRT_INGRESS_BRIDGE_BASE_URL="${SRT_INGRESS_BRIDGE_BASE_URL:-http://127.0.0.1:3310}"
...
API_STATUS_URL="${API_STATUS_URL:-http://$PUBLIC_HOST:3110/health}"
GATEWAY_STATUS_URL="${GATEWAY_STATUS_URL:-http://$PUBLIC_HOST:3111/health}"
TRANSLATION_AGENT_STATUS_BASE_URL="${TRANSLATION_AGENT_STATUS_BASE_URL:-http://$PUBLIC_HOST:8081}"
VOICE_AGENT_STATUS_URL="${VOICE_AGENT_STATUS_URL:-http://$PUBLIC_HOST:8082/}"
API_HEALTH_URL="${API_HEALTH_URL:-http://127.0.0.1:3110/health}"
GATEWAY_HEALTH_URL="${GATEWAY_HEALTH_URL:-http://127.0.0.1:3111/health}"
TRANSLATION_AGENT_HEALTH_URL="${TRANSLATION_AGENT_HEALTH_URL:-http://127.0.0.1:8081/worker}"
VOICE_AGENT_HEALTH_URL="${VOICE_AGENT_HEALTH_URL:-http://127.0.0.1:8082/}"
SRT_INGRESS_HEALTH_URL="${SRT_INGRESS_HEALTH_URL:-$SRT_INGRESS_BRIDGE_BASE_URL/health}"
TAILSCALE_SERVE_API_TARGET="${TAILSCALE_SERVE_API_TARGET:-http://127.0.0.1:3110}"
TAILSCALE_SERVE_RTC_TARGET="${TAILSCALE_SERVE_RTC_TARGET:-http://127.0.0.1:7880/rtc}"
TAILSCALE_SERVE_TWIRP_TARGET="${TAILSCALE_SERVE_TWIRP_TARGET:-http://127.0.0.1:7880/twirp}"
MODE="${1:-deploy}"
...
for value in \
  "$PUBLIC_HOST" "$CALL_PUBLIC_BASE_URL" "$CALL_LIVEKIT_URL" \
...
REALTIME_TRUST_PROXY_ADDRESSES=127.0.0.1,::1
