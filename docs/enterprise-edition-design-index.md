...
连接的本地自动化，当前 manifest 为公共31段、enterprise 30段；`ENT-DATA-008` 和
...
cutover/restore 证据和 production startup 绑定门禁；当前 `0017..0030` 必须按31+30重新生成切换证据。
...
execution；Agent 工具输出和真实 Adapter 仍分别待 `ENT-CS-006/007/008`。当前只进入静态门禁，
