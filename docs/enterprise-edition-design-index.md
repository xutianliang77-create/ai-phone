...
连接的本地自动化，当前 manifest 为公共31段、enterprise 14段；`ENT-DATA-008` 和
...
`ENT-CORE-007` 已增加 tenant usage budget、幂等 hold/settle、阈值告警和 append-only ledger
保护；真实设备/Provider、账务环境、A1/H2/H3 仍待完成。
