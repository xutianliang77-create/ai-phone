...
无界AI主产品30段公共 PostgreSQL migration、Primary Runtime、可靠 Inbox/Outbox、
...
连接的本地自动化，但不能继承主产品 staging 验收；`ENT-DATA-008/009` 仍需完成公共
通讯 tenant scope、企业独立切换/对账和真实 PostgreSQL H3 证据。
