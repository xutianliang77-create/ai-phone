...
- `ENT-DATA-001` 已实现二十八段 PostgreSQL up/down migration、复合 FK、强制 RLS、migration runner、schema verify 和归档 smoke；`0017..0028` 分别增加知识、术语/话术、企业 trace、审计导出、Meeting 聚合/入会/翻译、屏幕共享租约、会后材料、屏幕 OCR、日历同步和客服领域。历史本地 PostgreSQL 16 验证不替代当前31+28 staging migrate/restore/PITR，任务保持 `in_progress`。
