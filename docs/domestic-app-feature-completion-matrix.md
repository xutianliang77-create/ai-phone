...
| 自动朗读译文 | 代码和自动化门禁完成，默认关闭待真实验收 | `apps/mobile/lib/src/features/realtime/presentation/pages/realtime_page_online_helpers.dart`、`apps/mobile/lib/src/features/realtime/presentation/widgets/realtime_settings_panel.dart`、`apps/mobile/ios/Runner/AudioSessionCoordinator.swift`、`apps/mobile/android/app/src/main/kotlin/com/example/translation_mobile/AudioSessionCoordinator.kt` | 端侧系统 TTS 和在线 PCM 已接统一音频会话；需 iPhone/Android 连续 20 句确认 ASR 自动恢复且不识别自身朗读后，再决定默认开放。 |
