...
> **历史 POC 快照，不是当前 ASR 选型真值。** 本页保留 2026-07-05 当时的下载、
> runtime 和烟测证据；其 FireRed/Qwen0.6 排序已由
> `docs/asr-selection-decision-2026-08-02.md` 取代。当前无界AI服务器/多语种主
> ASR 固定为 Qwen3-ASR 1.7B，不得依据下表重开赛马或直接推断生产路由已迁移。
