...
| 8 | `OPT-UI-001~005` 长会话、连接状态与发布呈现 | code-ready/in_progress；真机横屏、120段长记录、连接/余额 live-region、最新 pending 单提醒、partial 降噪、iOS深色协议页及iPhone VoiceOver实体耳听全屏内容均已通过 | 最终生产Profile/Release截图与20次冷启动另门验收；Android TalkBack按当前里程碑后置 |
