...
export interface EnterpriseRepositoryRuntime
  extends EnterpriseKnowledgeRepositoryRuntime,
    ...
    EnterpriseMarketingMonitoringRepositoryRuntime, EnterpriseMarketingHandoffRepositoryRuntime, EnterpriseMarketingOutcomeRepositoryRuntime {
