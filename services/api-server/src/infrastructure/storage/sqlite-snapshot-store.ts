...
const collectionSpecs: CollectionSpec[] = [
  ...
  spec("agentRuns", "id"),
  spec("agentSteps", "id"),
  spec("agentToolExecutions", "id"),
  spec("agentHandoffs", "id"),
  spec("agentConsults", "id"),
  spec("externalMediaSources", "id"),
  spec("voiceProfiles", "id"),
  spec("voiceIdentities", "id"),
  spec("inboxEvents", "eventId"),
  spec("outboxEvents", "idempotencyKey"),
  spec("providerOperations", "id"),
  spec("workerDispatches", "id"),
  spec("workerCapacityReservations", "id"),
  spec("participantRecordingConsents", "id"),
  spec("recordingConsentSnapshots", "id"),
  spec("recordingJobs", "id"),
  spec("recordingArtifacts", "id"),
  spec("postgresProjectionEvents", "id"),
];
