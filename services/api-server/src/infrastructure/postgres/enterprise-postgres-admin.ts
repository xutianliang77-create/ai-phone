...
export const enterpriseTenantTableNames = [
  ...
  "billing_subscription_changes", "billing_provider_events",
  "billing_lifecycle_commands", "billing_lifecycle_decisions",
  ...
  "marketing_outcomes", "marketing_next_actions", "marketing_crm_syncs",
  "support_channels", "customer_profiles",
...
export const enterpriseSubjectColumns = [
  ...
  ["marketing_agent_profiles", "created_by"],
  ["marketing_handoff_policies", "created_by"],
  ["marketing_crm_syncs", "created_by"],
